...
public class ParkingTicket {
 ...
 @Column(name="expiry_date") private LocalDate expiryDate; @Column(name="issued_at") private LocalDateTime issuedAt; @Column(name="issued_to_reference") private String issuedToReference; @Version private long version;
 ...
 public TicketStatus getStatus(){return status;} public void setStatus(TicketStatus v){status=v;} public LocalDate getExpiryDate(){return expiryDate;} public void setExpiryDate(LocalDate v){expiryDate=v;}
