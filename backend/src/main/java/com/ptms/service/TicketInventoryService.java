...
@Service @Transactional public class TicketInventoryService{
 ...
 private TicketDto dto(ParkingTicket t){return new TicketDto(t.getId(),t.getBarcode(),t.getDurationHours(),t.getStatus(),t.getExpiryDate(),t.getCreatedAt(),t.getIssuedAt(),t.getIssuedToReference());}
}
