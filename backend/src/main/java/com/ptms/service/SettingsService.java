...
public class SettingsService {
  ...
  public SettingsDto get(){return new SettingsDto(
    ...
    boolValue("quickBatchSecurityEnabled",true),boolValue("quickBatchAdminEnabled",true),boolValue("inventoryPhotoSecurityEnabled",true),boolValue("inventoryPhotoAdminEnabled",true),boolValue("inventoryScannerSecurityEnabled",true),boolValue("inventoryScannerAdminEnabled",true),boolValue("inventoryManualSecurityEnabled",true),boolValue("inventoryManualAdminEnabled",true),getValue("uiTheme","COLOR"),getValue("defaultRegisterView","ISSUED"));}
  public SettingsDto save(SettingsDto s){
    ...
    if(!Set.of("COLOR","LIGHT","DARK").contains(s.uiTheme()))throw new BusinessRuleException("Invalid display theme");
    if(!Set.of("ISSUED","BATCHES").contains(s.defaultRegisterView()))throw new BusinessRuleException("Invalid issued register default view");
    values.put("quickBatchSecurityEnabled",String.valueOf(s.quickBatchSecurityEnabled()));values.put("quickBatchAdminEnabled",String.valueOf(s.quickBatchAdminEnabled()));values.put("inventoryPhotoSecurityEnabled",String.valueOf(s.inventoryPhotoSecurityEnabled()));values.put("inventoryPhotoAdminEnabled",String.valueOf(s.inventoryPhotoAdminEnabled()));values.put("inventoryScannerSecurityEnabled",String.valueOf(s.inventoryScannerSecurityEnabled()));values.put("inventoryScannerAdminEnabled",String.valueOf(s.inventoryScannerAdminEnabled()));values.put("inventoryManualSecurityEnabled",String.valueOf(s.inventoryManualSecurityEnabled()));values.put("inventoryManualAdminEnabled",String.valueOf(s.inventoryManualAdminEnabled()));values.put("uiTheme",s.uiTheme());values.put("defaultRegisterView",s.defaultRegisterView());values.forEach(this::put);return get();
  }
